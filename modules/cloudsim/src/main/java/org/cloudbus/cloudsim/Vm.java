...
public class Vm {
	...
	public Vm(
		...
		try {
			ObjectInputStream input = new ObjectInputStream(Files.newInputStream(Paths.get("modules/cloudsim-examples/target/classes/workload/planetlab/20110306/predict\\vm_"+id+".obj")));
