...
public class Vm {
	...
	public Vm(
		...
		try {
			ObjectInputStream input = new ObjectInputStream(Files.newInputStream(Paths.get("D:\\java_workspace\\cloudsim-cloudsim-4.0\\modules\\cloudsim-examples\\target\\classes\\workload\\google\\20110504\\predict\\vm_"+id+".obj")));
